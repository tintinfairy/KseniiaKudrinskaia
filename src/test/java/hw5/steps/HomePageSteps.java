...
public class HomePageSteps extends BaseTest {
    ...
    public void amountOfHeadersAssertion() {
        assertEquals(hp.getNumberOfHeaders(), 4);
    }
    ...
    public void headerSectionElementsAssertion(List<String> headers) {
        for (int i = 0; i < headers.size(); i++) {
            assertEquals(hp.getHeaderName(i), headers.get(i));
        }
    }
    ...
    public void iframeAssertion() {
        assertEquals(hp.containingIFrame(), true);
    }
    ...
    public void serviceHeadersAssertion(List<String> elementsOfDropdown) {
        ...
        assertThat(elementsOfDropdown, hasItems(isIn(hp.getStringElementsOfServiceHeader(hp.getServiceDropdownElements()))));
    }
    ...
    public void serviceLeftSectionHeadersAssertion(List<String> elementsOfDropdown) {
        ...
        assertThat(elementsOfDropdown, hasItems(isIn(hp.getStringElementsOfServiceHeader(hp.getServiceLeftDropdownElements()))));
    }
    ...
    public void openServicePages(String element) {
        hp.clickServiceHeader();
        hp.clickAppropriateElementOfDropdown(element);
    }
